    ...
    <script type="text/javascript">
        ...
        function doDelete() {
            ...
            if (rows.length == 0) {
                ...
                window.location.href = '${pageContext.request.contextPath}/staffAction_delete.action?ids=' + array.join(',');
            }
        }
...
<div class="easyui-window" title="对收派员进行修改" id="editStaffWindow" collapsible="false" minimizable="false"
    ...
    <div region="north" style="height:31px;overflow:hidden;" split="false" border="false">
        <div class="datagrid-toolbar">
            <a id="esave" icon="icon-save" href="#" class="easyui-linkbutton" plain="true">保存</a>
            <script>
                $(function () {
