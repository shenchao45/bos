    ...
    <script type="text/javascript">
        ...
        function doAssociations() {
            ...
            if (rows.length == 1) {
                ...
                var url1 = "${pageContext.request.contextPath}/decidedzoneAction_findnoassigncustomers.action"
...
//				alert(data)
                ...
                var url2 = "${pageContext.request.contextPath}/decidedzoneAction_findhasassigncustomers.action"
...
<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false"
    ...
    <div style="overflow:auto;padding:5px;" border="false">
        <form action="${pageContext.request.contextPath}/decidedzoneAction_add" method="post" id="addDecidedzoneForm">
